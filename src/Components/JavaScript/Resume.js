...
function Resume() {
  return (
    ...
    <section className='firstSection'>
      <h1 data-aso="fade-up" data-aos-once='true' className="heading_title flex items-center gap-[0.2rem]"><AiOutlineSafetyCertificate className='text-[#8127CF]'/>My Experience</h1>
      {resumeExperience.map(({workYear,role,location})=>(
      <div className=' mt-7' key={workYear} data-aos="fade-up">
    ...
    <section className='secondSection'>
      ...
      <div className=' mt-7' key={degree} data-aos="fade-up">

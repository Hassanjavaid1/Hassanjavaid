      ...
      <Element name="Mywork" className="Works">
        <section className="works text-center pt-[8rem] pb-[6rem]">
          ...
          <div className="mywork_shadow grid grid-cols-[repeat(2,0fr)] justify-center mt-[4rem] gap-[3rem]">
            {projectData.map(({ pro_title, pro_img, about, demo }) => (
              <div
                key={pro_title}
              ...
              >
                ...
                >
                  <div className="demo_box items-center relative bottom-[9rem] gap-[3rem] p-[1rem] text-left rounded-[10px] w-[30rem] bg-gradient-to-br from-purple-600 to-[#320d4e] text-left">
